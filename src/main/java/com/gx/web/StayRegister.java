...
public class StayRegister {
    ...
    @ResponseBody
    @RequestMapping(value = "/ajaxSelectTeamSumcont", produces = "application/json;charset=UTF-8")
    ...
    @ResponseBody
    @RequestMapping(value = "/confirmPassenger", produces = "application/json;charset=UTF-8")
    ...
    //ajax查询房间信息
    @ResponseBody
    @RequestMapping(value = "/ajaxSelectRoom", produces = "application/json;charset=UTF-8")
    ...
    //ajax查询房间信息
    @ResponseBody
    @RequestMapping(value = "/ajaxTeamSelectRoom", produces = "application/json;charset=UTF-8")
    ...
    //ajax查询房间信息
    @ResponseBody
    @RequestMapping(value = "/timeAjaxSelectRoomTwo", produces = "application/json;charset=UTF-8")
    ...
    //ajax查询房间信息
    @ResponseBody
    @RequestMapping(value = "/timeAjaxSelectRoomThree", produces = "application/json;charset=UTF-8")
    ...
    //ajax 安排房间的房间
    @ResponseBody
    @RequestMapping(value = "/guestRoomLevelSelectRoom", produces = "application/json;charset=UTF-8")
